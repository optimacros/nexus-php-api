 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MavenProxyRepositoryApiRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MavenProxyRepositoryApiRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'httpClient' => '\Optimacros\NexusPhpApi\Model\HttpClientAttributesWithPreemptiveAuth',
        'routingRule' => 'string',
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling MavenProxyRepositoryApiRequest., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets httpClient
     *
     * @return \Optimacros\NexusPhpApi\Model\HttpClientAttributesWithPreemptiveAuth
     */
     ...
     * Sets httpClient
     *
     * @param \Optimacros\NexusPhpApi\Model\HttpClientAttributesWithPreemptiveAuth $httpClient httpClient
     *
     * @return $this
     */
