...
class S3BlobStoreApiModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'bucketConfiguration' => '\Optimacros\NexusPhpApi\Model\S3BlobStoreApiBucketConfiguration',
        'type' => 'string'
    ];
     ...
     *
     * @return \Optimacros\NexusPhpApi\Model\S3BlobStoreApiBucketConfiguration
     */
     ...
     *
     * @param \Optimacros\NexusPhpApi\Model\S3BlobStoreApiBucketConfiguration $bucketConfiguration The S3 specific configuration details for the S3 object that'll contain the blob store.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The blob store type.
     *
     * @return $this
     */
