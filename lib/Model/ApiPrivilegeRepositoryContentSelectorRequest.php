...
/**
 * ApiPrivilegeRepositoryContentSelectorRequest Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApiPrivilegeRepositoryContentSelectorRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiPrivilegeRepositoryContentSelectorRequest';
    ...
    protected static $setters = [
        ...
        'contentSelector' => 'setContentSelector'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['contentSelector'] = isset($data['contentSelector']) ? $data['contentSelector'] : null;
    }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling ApiPrivilegeRepositoryContentSelectorRequest., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
    ...
    /**
     * Gets contentSelector
     *
     * @return string
     */
    public function getContentSelector()
    {
        return $this->container['contentSelector'];
    }

    /**
     * Sets contentSelector
     *
     * @param string $contentSelector The name of a content selector that will be used to grant access to content via this privilege.
     *
     * @return $this
     */
    public function setContentSelector($contentSelector)
    {
        $this->container['contentSelector'] = $contentSelector;
