...
/**
 * DockerHostedRepositoryApiRequest Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DockerHostedRepositoryApiRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DockerHostedRepositoryApiRequest';
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'online' => 'bool',
        'storage' => '\Optimacros\NexusPhpApi\Model\DockerHostedStorageAttributes',
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling DockerHostedRepositoryApiRequest., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets storage
     *
     * @return \Optimacros\NexusPhpApi\Model\DockerHostedStorageAttributes
     */
     ...
     * Sets storage
     *
     * @param \Optimacros\NexusPhpApi\Model\DockerHostedStorageAttributes $storage storage
     *
     * @return $this
     */
