...
/**
 * AptProxyApiRepository Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AptProxyApiRepository implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AptProxyApiRepository';
    ...
    protected static $swaggerTypes = [
        ...
        'apt' => '\Optimacros\NexusPhpApi\Model\AptProxyRepositoriesAttributes'
    ];
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling AptProxyApiRepository., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets apt
     *
     * @return \Optimacros\NexusPhpApi\Model\AptProxyRepositoriesAttributes
     */
     ...
     * Sets apt
     *
     * @param \Optimacros\NexusPhpApi\Model\AptProxyRepositoriesAttributes $apt apt
     *
     * @return $this
     */
