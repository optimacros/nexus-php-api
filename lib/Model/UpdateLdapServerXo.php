...
/**
 * UpdateLdapServerXo Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateLdapServerXo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateLdapServerXo';
    ...
    public function setConnectionTimeoutSeconds($connectionTimeoutSeconds)
    {
        ...
        if (($connectionTimeoutSeconds > 3600)) {
            throw new \InvalidArgumentException('invalid value for $connectionTimeoutSeconds when calling UpdateLdapServerXo., must be smaller than or equal to 3600.');
        }
        if (($connectionTimeoutSeconds < 1)) {
            throw new \InvalidArgumentException('invalid value for $connectionTimeoutSeconds when calling UpdateLdapServerXo., must be bigger than or equal to 1.');
        }
    ...
    public function setConnectionRetryDelaySeconds($connectionRetryDelaySeconds)
    {
        ...
        if (($connectionRetryDelaySeconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $connectionRetryDelaySeconds when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxIncidentsCount($maxIncidentsCount)
    {
        ...
        if (($maxIncidentsCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $maxIncidentsCount when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupObjectClass($groupObjectClass)
    {
        if (!is_null($groupObjectClass) && (mb_strlen($groupObjectClass) > 0)) {
            throw new \InvalidArgumentException('invalid length for $groupObjectClass when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($groupObjectClass) && (mb_strlen($groupObjectClass) < 0)) {
            throw new \InvalidArgumentException('invalid length for $groupObjectClass when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupIdAttribute($groupIdAttribute)
    {
        if (!is_null($groupIdAttribute) && (mb_strlen($groupIdAttribute) > 0)) {
            throw new \InvalidArgumentException('invalid length for $groupIdAttribute when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($groupIdAttribute) && (mb_strlen($groupIdAttribute) < 0)) {
            throw new \InvalidArgumentException('invalid length for $groupIdAttribute when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupMemberAttribute($groupMemberAttribute)
    {
        if (!is_null($groupMemberAttribute) && (mb_strlen($groupMemberAttribute) > 0)) {
            throw new \InvalidArgumentException('invalid length for $groupMemberAttribute when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($groupMemberAttribute) && (mb_strlen($groupMemberAttribute) < 0)) {
            throw new \InvalidArgumentException('invalid length for $groupMemberAttribute when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupMemberFormat($groupMemberFormat)
    {
        if (!is_null($groupMemberFormat) && (mb_strlen($groupMemberFormat) > 0)) {
            throw new \InvalidArgumentException('invalid length for $groupMemberFormat when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($groupMemberFormat) && (mb_strlen($groupMemberFormat) < 0)) {
            throw new \InvalidArgumentException('invalid length for $groupMemberFormat when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setUserMemberOfAttribute($userMemberOfAttribute)
    {
        if (!is_null($userMemberOfAttribute) && (mb_strlen($userMemberOfAttribute) > 0)) {
            throw new \InvalidArgumentException('invalid length for $userMemberOfAttribute when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($userMemberOfAttribute) && (mb_strlen($userMemberOfAttribute) < 0)) {
            throw new \InvalidArgumentException('invalid length for $userMemberOfAttribute when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
