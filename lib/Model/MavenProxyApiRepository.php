...
/**
 * MavenProxyApiRepository Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MavenProxyApiRepository implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MavenProxyApiRepository';
    ...
    protected static $swaggerTypes = [
        ...
        'maven' => '\Optimacros\NexusPhpApi\Model\MavenAttributes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['maven'] = isset($data['maven']) ? $data['maven'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['maven'] === null) {
            $invalidProperties[] = "'maven' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling MavenProxyApiRepository., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets maven
     *
     * @return \Optimacros\NexusPhpApi\Model\MavenAttributes
     */
    public function getMaven()
    {
        return $this->container['maven'];
    }

    /**
     * Sets maven
     *
     * @param \Optimacros\NexusPhpApi\Model\MavenAttributes $maven maven
     *
     * @return $this
     */
    public function setMaven($maven)
    {
        $this->container['maven'] = $maven;
