...
/**
 * NpmProxyApiRepository Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NpmProxyApiRepository implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NpmProxyApiRepository';
    ...
    protected static $swaggerTypes = [
        ...
        'npm' => '\Optimacros\NexusPhpApi\Model\NpmAttributes'
    ];
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling NpmProxyApiRepository., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets npm
     *
     * @return \Optimacros\NexusPhpApi\Model\NpmAttributes
     */
     ...
     * Sets npm
     *
     * @param \Optimacros\NexusPhpApi\Model\NpmAttributes $npm npm
     *
     * @return $this
     */
