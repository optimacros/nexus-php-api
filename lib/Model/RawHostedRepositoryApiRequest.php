 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RawHostedRepositoryApiRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RawHostedRepositoryApiRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'raw' => '\Optimacros\NexusPhpApi\Model\RawAttributes'
    ];
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling RawHostedRepositoryApiRequest., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets raw
     *
     * @return \Optimacros\NexusPhpApi\Model\RawAttributes
     */
     ...
     * Sets raw
     *
     * @param \Optimacros\NexusPhpApi\Model\RawAttributes $raw raw
     *
     * @return $this
     */
