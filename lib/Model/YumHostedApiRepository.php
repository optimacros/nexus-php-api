...
/**
 * YumHostedApiRepository Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class YumHostedApiRepository implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'YumHostedApiRepository';
    ...
    protected static $swaggerTypes = [
        ...
        'yum' => '\Optimacros\NexusPhpApi\Model\YumAttributes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['yum'] = isset($data['yum']) ? $data['yum'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['yum'] === null) {
            $invalidProperties[] = "'yum' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling YumHostedApiRepository., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets yum
     *
     * @return \Optimacros\NexusPhpApi\Model\YumAttributes
     */
    public function getYum()
    {
        return $this->container['yum'];
    }

    /**
     * Sets yum
     *
     * @param \Optimacros\NexusPhpApi\Model\YumAttributes $yum yum
     *
     * @return $this
     */
    public function setYum($yum)
    {
        $this->container['yum'] = $yum;
