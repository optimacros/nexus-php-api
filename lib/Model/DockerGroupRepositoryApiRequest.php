 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DockerGroupRepositoryApiRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DockerGroupRepositoryApiRequest';
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling DockerGroupRepositoryApiRequest., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
