...
/**
 * DockerProxyApiRepository Class Doc Comment
 *
 * @category Class
 * @package  Optimacros\NexusPhpApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DockerProxyApiRepository implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DockerProxyApiRepository';
    ...
    protected static $swaggerTypes = [
        ...
        'docker' => '\Optimacros\NexusPhpApi\Model\DockerAttributes',
        'dockerProxy' => '\Optimacros\NexusPhpApi\Model\DockerProxyAttributes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['dockerProxy'] = isset($data['dockerProxy']) ? $data['dockerProxy'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dockerProxy'] === null) {
            $invalidProperties[] = "'dockerProxy' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling DockerProxyApiRepository., must conform to the pattern /^[a-zA-Z0-9\\-]{1}[a-zA-Z0-9_\\-\\.]*$/.");
        }
     ...
     * Gets docker
     *
     * @return \Optimacros\NexusPhpApi\Model\DockerAttributes
     */
     ...
     * Sets docker
     *
     * @param \Optimacros\NexusPhpApi\Model\DockerAttributes $docker docker
     *
     * @return $this
     */
     ...
     * Gets dockerProxy
     *
     * @return \Optimacros\NexusPhpApi\Model\DockerProxyAttributes
     */
    public function getDockerProxy()
    {
        return $this->container['dockerProxy'];
    }

    /**
     * Sets dockerProxy
     *
     * @param \Optimacros\NexusPhpApi\Model\DockerProxyAttributes $dockerProxy dockerProxy
     *
     * @return $this
     */
    public function setDockerProxy($dockerProxy)
    {
        $this->container['dockerProxy'] = $dockerProxy;
