...
class SecurityManagementRolesApi
{
     ...
     * Create role
     *
     * @param  \Optimacros\NexusPhpApi\Model\RoleXORequest $body A role configuration (required)
     *
     * @throws \Optimacros\NexusPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Optimacros\NexusPhpApi\Model\RoleXOResponse
     */
     ...
     * @throws \Optimacros\NexusPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Optimacros\NexusPhpApi\Model\RoleXOResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($body)
    {
        $returnType = '\Optimacros\NexusPhpApi\Model\RoleXOResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Optimacros\NexusPhpApi\Model\RoleXOResponse',
    ...
    protected function createRequest($body)
    {
        ...
        $resourcePath = '/v1/security/roles';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/v1/security/roles/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getRoleWithHttpInfo($id, $source);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRoleAsync($id, $source = 'default')
    {
        return $this->getRoleAsyncWithHttpInfo($id, $source)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRoleRequest($id, $source = 'default')
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getRolesWithHttpInfo($source);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRolesAsync($source = null)
    {
        return $this->getRolesAsyncWithHttpInfo($source)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRolesRequest($source = null)
    {
     ...
     * @return void
     */
    public function update1($id, $body)
    {
        $this->update1WithHttpInfo($id, $body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function update1WithHttpInfo($id, $body)
    {
        $returnType = '';
        $request = $this->update1Request($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function update1Async($id, $body)
    {
        return $this->update1AsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function update1AsyncWithHttpInfo($id, $body)
    {
        $returnType = '';
        $request = $this->update1Request($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function update1Request($id, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
