...
class TasksApi
{
     ...
     * @return \Optimacros\NexusPhpApi\Model\TaskXO
     */
     ...
     * @throws \Optimacros\NexusPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Optimacros\NexusPhpApi\Model\TaskXO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTaskByIdWithHttpInfo($id)
    {
        $returnType = '\Optimacros\NexusPhpApi\Model\TaskXO';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Optimacros\NexusPhpApi\Model\TaskXO',
     ...
     * @throws \Optimacros\NexusPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Optimacros\NexusPhpApi\Model\PageTaskXO
     */
     ...
     * @throws \Optimacros\NexusPhpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Optimacros\NexusPhpApi\Model\PageTaskXO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTasksWithHttpInfo($type = null)
    {
        $returnType = '\Optimacros\NexusPhpApi\Model\PageTaskXO';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Optimacros\NexusPhpApi\Model\PageTaskXO',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
